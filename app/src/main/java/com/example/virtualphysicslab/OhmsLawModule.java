...
public class OhmsLawModule extends AppCompatActivity {
    ...
    static public String[] getData() {
        if (LoginFragment.isTeacher)
            data = new String[]{"Theory", "Apparatus", "Simulation", "Viva", "Help", "Assessment"};
        else data = new String[]{"Theory", "Apparatus", "Simulation", "Viva", "Help"};
        return data;
    }
